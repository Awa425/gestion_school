 ...
 */
final class Version20220602135335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, rp_id INT NOT NULL, niveau VARCHAR(30) NOT NULL, filliere VARCHAR(30) NOT NULL, libelle VARCHAR(50) NOT NULL, INDEX IDX_8F87BF96B70FF80C (rp_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, anneescolaire_id_id INT NOT NULL, ac_id INT NOT NULL, etudiant_id INT NOT NULL, INDEX IDX_5E90F6D67FA44D (anneescolaire_id_id), INDEX IDX_5E90F6D6D2E3ED2F (ac_id), INDEX IDX_5E90F6D6DDEAB1A3 (etudiant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
